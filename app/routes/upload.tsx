...
const Upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File  }) => {
        ...
        try {
            ...
            // Add a timeout so we don't get stuck on "Analyzing..." forever
            ...
            if (!feedback) {
                setStatusText('Analysis took too long, showing saved data.');
            } else {
                let feedbackRaw: string;
                const content = feedback.message.content as any;
